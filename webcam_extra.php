...
// echo $series_to_create_qr;
      // "qr".implode("_",$_SESSION[$id]).'.png'
      $qr_file_name = "qr".$series_to_create_qr.'.png';
$file_store_as=$path.$qr_file_name;
//$qr_file_name = "qr".implode("_",$_SESSION[$data_in_ls_with_key]).'.png';
// echo $file_store_as;
...
<div class="container-fluid">
  ...
  <div class="row w-100 justify-content-center">
	...
	<div class="container_of_objects">
...
<input type="button" class="btn btn-info btn-round btn-file w-100 h-10 m-none" value="Take Snapshot" id="capture" onclick="capture()"  >	
	...
	<div  class="m-2 d-flex flex-column justify-content-center align-items-center"  align="center">
		...
		<button type="submit" class="button" name='submission_trigger' >Submit</button><!--onclick="saveSnap()"-->
        ...
        <script>
//(document.getElementById('capture')).addEventListener('touchStart',capture,false)
...
if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
  ...
  function requestCamera() {
    ...
    if (hasRearCamera) {
	  ...
	  videoConstraints.video.facingMode = {exact:"environment"};
...
document.getElementById('capture').addEventListener("touchend",capture);
